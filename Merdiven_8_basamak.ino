...
int merdiven_led_up[8] = {11, 10, 9, 8, 7, 6, 5, 4,}; // 11 adet led için dizi tanımı _ string
int merdiven_led_down[8] = {4, 5, 6, 7, 8, 9, 10, 11,}; // 11 adet led için dizi tanımı ters sırada_ reverse string
