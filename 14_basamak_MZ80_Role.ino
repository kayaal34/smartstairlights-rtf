...
int merdiven_led_up[14] =   { 10, 9, 8, 7, 6, 5, 4, 3, 2, A5, A4, A3, A2, A1,}; // 14 adet led için dizi tanımı _ string
int merdiven_led_down[14] = {A1, A2, A3, A4, A5, 2, 3, 4, 5, 6, 7, 8, 9, 10, }; // 14 adet led için dizi tanımı ters sırada_ reverse string
